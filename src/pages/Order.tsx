...
import { Calendar, CheckCircle2, ShieldAlert, Send } from 'lucide-react';
import { useAuth } from '../context/AuthContext';
import { BackButton } from '../components/BackButton';

// Mock Data (In a real app, fetch via API based on ID)
const mockServices: Service[] = [
  { id: '1', title: 'Développement Site Web Vitrine', category: 'Informatique', price: 150000, providerName: 'DigitAgency', rating: 4.8, reviews: 24, image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
  { id: '2', title: 'Plomberie & Réparations', category: 'Maison', price: 15000, providerName: 'Jean Michel', rating: 4.5, reviews: 12, image: 'https://images.unsplash.com/photo-1581244277943-fe4a9c777189?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
  { id: '3', title: 'Consulting Marketing Digital', category: 'Marketing', price: 50000, providerName: 'Sarah Ndiaye', rating: 5.0, reviews: 8, image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
  { id: '4', title: 'Installation Électrique', category: 'Maison', price: 25000, providerName: 'ElecPro', rating: 4.2, reviews: 30, image: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
  { id: '5', title: 'Cours de Cuisine Sénégalaise', category: 'Formation', price: 10000, providerName: 'Chef Amina', rating: 4.9, reviews: 56, image: 'https://images.unsplash.com/photo-1556910103-1c02745a30bf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
  { id: '6', title: 'Design de Logo & Branding', category: 'Design', price: 75000, providerName: 'Creative Studio', rating: 4.7, reviews: 19, image: 'https://images.unsplash.com/photo-1626785774573-4b799315545d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Header */}
        <BackButton label="Retour aux services" />
            ...
            {step === 2 && (
                <div className="bg-white dark:bg-gray-800 rounded-xl p-12 shadow-sm border border-gray-100 dark:border-gray-700 text-center animate-in zoom-in duration-300">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-8">
                        Le prestataire <strong>{service.providerName}</strong> a reçu votre demande. Il vous contactera sous peu via la messagerie JOM ou par téléphone pour confirmer le rendez-vous et les modalités de paiement.
                    </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 sticky top-24">
                ...
                <div className="flex gap-3 mb-4 pb-4 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Par {service.providerName}</p>
                    </div>
                </div>
                ...
                <div className="space-y-3 text-sm">
                    <div className="flex justify-between text-gray-600 dark:text-gray-300">
                        ...
                        <span className="font-bold">{service.price.toLocaleString()} FCFA</span>
                    </div>
